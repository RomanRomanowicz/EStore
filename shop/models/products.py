...
from .category import Category, CategoryColor, CategorySize
...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='products/%Y/%m/%d', blank=True, verbose_name='главное фото')
    description = models.TextField(blank=True, verbose_name='описание')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='цена', null=True, blank=True)
    stock = models.PositiveIntegerField()
    color = models.ForeignKey(CategoryColor, on_delete=models.CASCADE, related_name='products', default=None,
                              verbose_name='Цвет', null=True, blank=True)
    size = models.ForeignKey(CategorySize, on_delete=models.CASCADE, related_name='products',
                             default='All Size', verbose_name='Размер', null=True, blank=True)
